...
- Name: car-shop.spec.js >> catalog filters cars by model
- Location: tests/ui/car-shop.spec.js:39:1
...
Call log:
  ...
  - waiting for getByTestId('cars-page')
